...
def build_ai_zone_market_trade(
    ...
    risk_percent = env_float("AI_ZONE_ENTRY_RISK_PERCENT", 1.0)
    ...
    v8_risk_reason = f"ai_zone_market@{risk_percent}pct"
    ...
    trade = {
        ...
        "ai_zone_reason": "Valid active zone confirmed; OB was not mitigated; AI zone market entry at 1% risk.",
...
def build_trade_from_summary(summary: dict, symbol_info, tick):
    ...
    risk_percent = env_float("PENDING_LIMIT_RISK_PERCENT", 0.5)
    lot, risk_amount, loss_per_1_lot, actual_risk_amount, actual_risk_percent = calculate_lot_size(
        symbol_info.name,
        entry,
        stop_loss,
    ...
    v8_risk_reason = f"pending_limit@{risk_percent}pct"
